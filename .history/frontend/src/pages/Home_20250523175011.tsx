    ...
    <div className={styles['home-container']}>
      ...
      <div className={styles['search-bar']}>
        ...
        <AntButton
          ...
          loading={loading}
          disabled={!keyword}
          style={{ borderRadius: '16px', padding: '14px 0', fontSize: '1.1rem', fontWeight: 500, marginRight: '10px' }} // 保持原有部分样式，并添加右边距
        >
          搜索新闻
        </AntButton>
        {/* 新增设置按钮 */}
        <AntButton
          ...
          style={{ width:'50px',borderRadius: '16px', padding: '14px 0', fontSize: '1.1rem', fontWeight: 500 }}
        />
      </div>
