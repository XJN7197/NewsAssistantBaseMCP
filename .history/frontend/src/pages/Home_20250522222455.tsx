...
import { List, Checkbox, Button as AntButton, Input, Spin, Modal, Typography, Dropdown } from 'antd'; // Ant Design 组件导入
  ...
  const handleDownload = (type: string) => {
    ...
    if (type === 'markdown') {
      ...
      try {
        ...
        // 添加时间戳
        doc.setFontSize(12);
        doc.text(`Generated at: ${new Date().toLocaleString('en-US')}`, 20, 30);
      ...
      // 保存PDF文件
      doc.save(`舆情分析报告_${timestamp}.pdf`);
    }
  };
