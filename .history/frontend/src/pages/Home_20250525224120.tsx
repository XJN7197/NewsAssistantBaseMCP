    ...
    <div className={styles['home-container']}>
      ...
      >
        {loading ? (
          ...
          <List
            height={400} // Adjust height as needed, based on Modal body max-height
            itemCount={historyReports.length}
            itemSize={120} // Approximate height of each list item, adjust as needed
            width="100%"
          >
            {HistoryReportRow}
          </List>
