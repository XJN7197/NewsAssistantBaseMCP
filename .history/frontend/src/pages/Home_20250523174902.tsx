...
import { List, Checkbox, Button as AntButton, Input, Spin, Modal, Typography, Form, message } from 'antd'; // Ant Design 组件导入
...
import { SettingOutlined } from '@ant-design/icons'; // 导入设置图标
    ...
    <div className={styles['home-container']}>
      ...
      <div className={styles['search-bar']}>
        ...
        <AntButton
          ...
          loading={loading}
          disabled={!keyword}
          style={{ borderRadius: '16px', padding: '14px 36px', fontSize: '1.1rem', fontWeight: 500, marginRight: '10px' }} // 保持原有部分样式，并添加右边距
        >
          搜索新闻
        </AntButton>
        {/* 新增设置按钮 */}
        <AntButton
          ...
          style={{ width:'100px',borderRadius: '16px', padding: '14px', fontSize: '1.1rem', fontWeight: 500 }}
        />
      </div>
